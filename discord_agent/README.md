...
- 💬 **Общая память чата**: Запоминает историю общения для всего канала
- 👥 **Учет участия пользователей**: Отслеживает вклад каждого участника
- 📌 **Обнаружение тем**: Автоматически определяет темы обсуждения
- ⭐ **Выделение важных сообщений**: Обнаруживает и сохраняет ключевые моменты
- 📋 **Отслеживание задач**: Выявляет задачи и действия из разговора
- 🧠 **Расширенные промпты**: Гибкая система промптов с учетом контекста
